...
@pytest.mark.asyncio
async def test_register_user_success(client, db_session, seed_database, mock_email_sender):
    payload = {
...
@pytest.mark.asyncio
async def test_register_user_conflict(client, db_session, seed_user_groups, mock_email_sender):
    payload = {
        "email": "conflictuser@example.com",
        "password": "StrongPassword123!"
    }
    response_first = await client.post("/api/v1/users/register/", json=payload)
    response_second = await client.post("/api/v1/users/register/", json=payload)
...
@pytest.mark.asyncio
async def test_register_user_internal_server_error(client, seed_user_groups, mock_email_sender):
    payload = {
...
@pytest.mark.asyncio
async def test_activate_account_success(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }

    registration_response = await client.post("/api/v1/users/register/", json=registration_payload)
    ...
    activation_response = await client.post("/api/v1/users/activate/", json=activation_payload)
...
@pytest.mark.asyncio
async def test_activate_user_with_expired_token(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
...
@pytest.mark.asyncio
async def test_activate_user_with_deleted_token(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
...
@pytest.mark.asyncio
async def test_activate_already_active_user(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
...
@pytest.mark.asyncio
async def test_request_password_reset_token_success(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
    ...
    reset_response = await client.post("/api/v1/users/password-reset/request/", json=reset_payload)
...
@pytest.mark.asyncio
async def test_request_password_reset_token_nonexistent_user(client, db_session, mock_email_sender):
...
@pytest.mark.asyncio
async def test_request_password_reset_token_for_inactive_user(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
...
@pytest.mark.asyncio
async def test_reset_password_success(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
    ...
    reset_request_response = await client.post("/api/v1/users/password-reset/request/", json=reset_request_payload)
    ...
    reset_response = await client.post("/api/v1/users/reset-password/complete/", json=reset_payload)
...
async def test_reset_password_invalid_email(client, db_session):
    ...
    response = await client.post("/api/v1/users/reset-password/complete/", json=reset_payload)
...
@pytest.mark.asyncio
async def test_reset_password_invalid_token(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
    response = await client.post("/api/v1/users/register/", json=registration_payload)
    ...
    reset_request_payload = {"email": registration_payload["email"]}
    response = await client.post("/api/v1/users/password-reset/request/", json=reset_request_payload)
    ...
    response = await client.post("/api/v1/users/reset-password/complete/", json=reset_complete_payload)
...
@pytest.mark.asyncio
async def test_reset_password_expired_token(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
    ...
    reset_response = await client.post("/api/v1/users/reset-password/complete/", json=reset_complete_payload)
...
@pytest.mark.asyncio
async def test_reset_password_sqlalchemy_error(client, db_session, seed_user_groups, mock_email_sender):
    registration_payload = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
...
async def test_login_user_success(client, db_session, jwt_manager, seed_user_groups):
    ...
    assert response.status_code == 200, "Expected status code 201 for successful login."
    response_data = response.json()
...
async def test_login_user_invalid_cases(client, db_session, seed_user_groups):
    ...
    response = await client.post("/api/v1/users/login/", json=login_payload_incorrect_password)
...
async def test_refresh_access_token_success(client, db_session, jwt_manager, seed_user_groups):
    ...
    refresh_response = await client.post("/api/v1/users/refresh/", json=refresh_payload)
